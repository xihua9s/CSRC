...
Subroutine solver_staggered_LSDYNA(ini_cmt,mesh_phys)
	implicit none
	...
	Do While (ini_cmt%current_time < ini_cmt%Time_stop)
		...
		Call solver_staggered_LSDYNA_details( &
			ini_cmt%nx,      &
			ini_cmt%dt,      &
...
end Subroutine solver_staggered_LSDYNA


Subroutine solver_staggered_LSDYNA_details(nx,dt,den,pre,sos,ein,mass,eos,&
...
end Subroutine solver_staggered_LSDYNA_details


end module mdu_LSDYNA  
