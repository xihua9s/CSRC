!> Last Modified : Sat Feb 25 20:23:51 2023


Module MDU_Initial_s321
	use common_inicmt
	use common_meshphys
	use fluid_euler_eqn_basic
Contains

	Subroutine Initial_Mesh_Phys_s321(ini_cmt,mesh_phys)
		implicit none
		...
		mesh_phys%bnd_con(2) = -1
		mesh_phys%bnd_vel_pre(1) =  2.d0 
		mesh_phys%bnd_vel_pre(2) = -2.d0 
		mesh_phys%bnd_vel_pre(3) =  0.d0 
		mesh_phys%bnd_vel_pre(4) =  0.d0 

	End Subroutine Initial_Mesh_Phys_s321


End Module MDU_Initial_s321
