!> Last Modified : Sat Feb 25 20:24:14 2023
...
Contains
	...
	Subroutine Initial_Mesh_Phys_exp2vac(ini_cmt,mesh_phys)
		implicit none
	...
	enddo
		...
		mesh_phys%bnd_con(2) = -5
		mesh_phys%bnd_vel_pre(1) = 0.d0 
		mesh_phys%bnd_vel_pre(2) = 1.d-6


	End Subroutine Initial_Mesh_Phys_exp2vac
