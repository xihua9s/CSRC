...
Subroutine Initial_Mesh_Phys_water_air(ini_cmt,mesh_phys)
	implicit none
	...
	integer :: ix
	real*8  :: dx,pvar(3),cvar(3),sos,ein,xmid,gamma3(3),gamma

	ini_cmt%time_stop = 0.00024d0
...
End Subroutine Initial_Mesh_Phys_water_air


End Module MDU_Initial_stiff
