...
! |          |            |
! -------------------------
subroutine cal_mjsls_details_subcell_pre4_in_cy(nx,ny,eos,vertx,verty, &
   vstarx,vstary,den,pre,sound,gamar,amass,xc,yc,pre1,pre1_in)
	implicit none 
   integer :: nx,ny
...
end subroutine cal_mjsls_details_subcell_pre4_in_cy



subroutine cal_subcell_p4_in_cy(x1,y1,x2,y2,x3,y3,x4,y4,&
   ...
   do side = 1 , 4
      ...
      pre1_in(side)  = 0.d0 !sound**2 * (amass/2.d0/(sub_area(i1)+sub_area(i2)) - den) 
   enddo 

end subroutine cal_subcell_p4_in_cy
