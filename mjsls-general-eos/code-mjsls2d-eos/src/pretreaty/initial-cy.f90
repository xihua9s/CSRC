...
subroutine initial_cy(supt,den,pre,sound,enin,eos, &
   ...
   case('sod_circle')
      call initial_sod_circle_cy_aw(supt,den,pre,sound,enin,eos, &
            vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
            bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('s123_rec')
   !    call initial_s123_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('exp2vac_rec')
   !    call initial_exp2vac_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('exp2vac_cir')
   !    call initial_exp2vac_circle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('leblanc_rec')
   !    call initial_leblanc_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('sedov_rec')
   !    call initial_sedov_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('sedov4_rec')
   !    call initial_sedov4_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('noh_rec')
   !    call initial_noh_rectangle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('noh_cir')
   !    call initial_noh_circle_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)
   ! case('saltzmann')
   !    call initial_saltzmann_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)       
   ! case('triple')
   !    call initial_triple_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)    
   ! case('rti')
   !    call initial_rti_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,g)  
   ! case('acousticpulse')
   !    call initial_acousticpulse_cy(supt,den,pre,sound,enin,eos, &
   !          vertx,verty,amass,gamar,nx,ny,vstarx,vstary, &
   !          bnd_type,Vertex_Type_norm_pre,pmass,smass,smass_tri)                
   case  default
