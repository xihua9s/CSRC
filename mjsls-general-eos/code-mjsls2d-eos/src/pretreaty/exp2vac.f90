...
!> 20221228
!> xihua
!> initial exp2vac_rectangle problem

subroutine initial_exp2vac_rectangle_ca(supt,den,pre,sound,enin,eos, &
...
end subroutine initial_exp2vac_rectangle_ca

!> 20221228
!> xihua
!> initial exp2vac_circle problem

subroutine initial_exp2vac_circle_ca(supt,den,pre,sound,enin,eos, &
   vertx,verty,amass,gamar,nx,ny,vstarx,vstary,bnd_type,&
   Vertex_Type_norm_pre,pmass,smass,smass_tri)
	implicit none
	real*8 :: den(1:nx,1:ny),pre(1:nx,1:ny),amass(1:nx,1:ny)
   ...
   gamar = 7.d0 / 5.d0 
	...
	xl=1.d-2 ; xr=1.d0
	yd=0.d0 ; yu= 3.14159265359d0 / 2.d0 
	dx=(xr-xl)/nx  
	dy=(yu-yd)/ny
   ...
   call cal_geo_2d(nx,ny,vertx,verty,den,area,volm,subcell_area_ca,smass,amass,parea,pvolm,pmass,smass_tri)
...
end subroutine initial_exp2vac_circle_ca
