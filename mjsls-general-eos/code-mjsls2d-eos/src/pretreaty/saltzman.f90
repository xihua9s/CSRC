...
!> 20221220
!> xihua
!> initial saltzmann problem
subroutine initial_saltzmann_ca(supt,den,pre,sound,enin,eos, &
   ...
   Pi    = 3.14159265359d0 
	...
	do j=0,ny
   !		vertx(i,j)= xl + dx * i
		vertx(i,j)= i*dx + (10.d0-j)*dy*sin(pi*i*dx)
		verty(i,j)= yd + dy * j
	enddo
   enddo        
...
end subroutine initial_saltzmann_ca
